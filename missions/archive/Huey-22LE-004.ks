...
print " ".
print "################################".
print "# HUEY-22LE-004 FLIGHT PROGRAM #".
print "# LSS-I-1 LEO INSERTION        #".
print "################################".
print " ".
...
local TGT_INCL is 90. // guidance heading (not inclination), Canaveral lowest energy launch = 118.5, polar is 180
