...
print "# SH PRECISION HOVERSLAM TESTFLIGHT 3                    #".
print "#                                                        #".
...
local TGANTRY is 2. // Gantry at T-Minus...
...
local AGL_TWEAK is 0. // hoverslam AGL tweak - a little extra height to account for struts etc
