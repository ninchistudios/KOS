...
print " ".
print "################################".
print "# HUEY-22LE-002 FLIGHT PROGRAM #".
print "# 3x CommSat II LEO INSERTION  #".
print "################################".
print " ".
...
local TGT_INCL is 0. // target orbital inclination, Canaveral lowest energy launch = 118.5
